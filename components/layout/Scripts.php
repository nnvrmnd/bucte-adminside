<!-- WAIT MODAL -->
<div class="modal fade" id="WaitModal" tabindex="-1" role="dialog" aria-labelledby="WaitModal"
		...
		<div class="modal-content bg-gradient-info">
			...
			<div class="modal-body">
				<div class="py-3 text-center">
					...
					<h4 class="heading mt-4">PLEASE WAIT!</h4>
					<p class="font-weight-normal" id="wait-modal-msg"></p>
				</div>
			</div>
