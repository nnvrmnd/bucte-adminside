                                        ...
                                        <div class="content-wrap">
                                            <section id="vision">
                                                <form role="form" id="formV" enctype="multipart/form-data" style="display: none;">
                                                    <input type="password" class="d-none" value="vision" name="alias"
                                                        id="alias" hidden>
                                                    <div class="col-md-12">
                                                        <div class="form-group mb-2">
                                                            <label class="form-control-label"
                                                                for="content">Vision</label>
                                                            <textarea class="form-control ckwriteV" name="content"
                                                                id="vision_body" rows="5"
                                                                placeholder="Write content body..."></textarea>
                                                            <small class="vision_body"></small>
                                                        </div>
                                                        <div class="form-group mb-2 flex-center">
                                                            <div class="btn-xlg-container"><button type="submit"
                                                                    name="save_vision"
                                            ...
                                            <section id="mission">
                                                <form role="form" id="formM" enctype="multipart/form-data" style="display:none;">
                                                    <input type="password" class="d-none" value="mission" name="alias"
                                                        id="alias" hidden>
                                                    <div class="col-md-12">
                                                        <div class="form-group mb-2">
                                                            <label class="form-control-label"
                                                                for="content">Mission</label>
                                                            <textarea class="form-control ckwriteM" name="content"
                                                                id="mission_body" rows="5"
                                            ...
                                            <section id="objectives">
                                                <form role="form" id="formO" enctype="multipart/form-data" style="display: none">
                                                    <input type="password" class="d-none" value="objectives"
                                                        name="alias" id="alias" hidden>
                                                    <div class="form-group mb-2">
                                                        <label class="form-control-label"
                                                            for="content">Objectives</label>
                                                        <textarea class="form-control ckwriteO" name="content"
                                                            id="obj_body" rows="5" placeholder="Write content body..."
                                                            required></textarea>
