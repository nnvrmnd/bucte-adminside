...
<body>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group mb-2">
									...
									<input type="text" class="form-control text-dark resource-input" name="title"
								...
								<div class="form-group mb-2">
									...
									<textarea class="form-control text-dark resource-input" name="description"
	...
	<div class="modal fade" id="EditResource" tabindex="-1" role="dialog" aria-labelledby="EditResourceLabel"
		aria-hidden="true">
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="EditResourceLabel">Edit resource</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
				<form role="form" id="edit_form">
					<div class="modal-body">
						<input type="password" class="d-none" name="resource_id" id="resource_id">
						<div class="row">
							<div class="col-md-12">
								<div class="form-group mb-2">
									<label class="form-control-label" for="edt_title">File title</label>
									<input type="text" class="form-control text-dark resource-input" name="edt_title"
								...
								<div class="form-group mb-2">
									...
									<textarea class="form-control text-dark resource-input" name="edt_description"
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-sm btn-secondary text-danger edit_delete delete_resource"
						title="Delete resource..." data-dismiss="modal">
