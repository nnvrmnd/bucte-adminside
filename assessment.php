        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <button class="btn btn-sm btn-neutral" id="add_btn" data-toggle="modal" data-target="#AddItem"
								title="Add item...">Add item</button>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group mb-3">
                  ...
                  <textarea class="form-control text-dark question" name="question" id="question" rows="2" placeholder="Write a question..."></textarea>
                ...
                <div class="input-group mb-2">
                  ...
                  <input type="text" class="form-control text-dark options" name="optionA" id="answer" data-radio="a" placeholder="First choice">
                </div>
                <div class="input-group mb-2">
                  <div class="input-group-prepend">
                  ...
                  <input type="text" class="form-control text-dark options" name="optionB" data-radio="b" placeholder="Second choice">
                </div>
                <div class="input-group mb-2">
                  <div class="input-group-prepend">
                  ...
                  <input type="text" class="form-control text-dark options" name="optionC" data-radio="c" placeholder="Third choice">
                </div>
                <div class="input-group mb-2">
                  <div class="input-group-prepend">
                  ...
                  <input type="text" class="form-control text-dark options" name="optionD" data-radio="d"
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group mb-3">
                  ...
                  <textarea class="form-control text-dark question" name="edt_question" id="edt_question" rows="2" placeholder="Write a question..."></textarea>
                ...
                <div class="input-group mb-2">
                  ...
                  <input type="text" class="form-control text-dark options" name="optionA" id="edt_answer" data-radio="a" placeholder="First choice">
                </div>
                <div class="input-group mb-2">
                  <div class="input-group-prepend">
                    <div class="input-group-text" data-target="b">
