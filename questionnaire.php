				...
				<div class="header-body">
					<div class="row align-items-center py-4">
						...
						<div class="col-lg-6 col-5 text-right">
							<button class="btn btn-sm btn-neutral" data-toggle="modal" data-target="#AddItem">Add
								item</button>
						</div>
					</div>
				</div>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="input-group mb-2">
									...
									<input type="text" class="form-control text-dark options" data-radio="a"
										name="optionA" placeholder="First choice">
								</div>
								<div class="input-group mb-2">
									<div class="input-group-prepend">
									...
									<input type="text" class="form-control text-dark options" data-radio="b"
										name="optionB" placeholder="Second choice">
								</div>
								<div class="input-group mb-2">
									<div class="input-group-prepend">
									...
									<input type="text" class="form-control text-dark options" data-radio="c"
										name="optionC" placeholder="Third choice">
								</div>
								<div class="input-group mb-2">
									<div class="input-group-prepend">
									...
									<input type="text" class="form-control text-dark options" data-radio="d"
										name="optionD" placeholder="Fourth choice">
								</div>
